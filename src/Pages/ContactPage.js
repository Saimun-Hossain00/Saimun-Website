        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+01 993102200'} text2={'+01  793408959'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'saimunhossaiemon@gmail.com'} text2={'saimunhossain711@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'Dhaka,Bangladesh'} text2={'Dhaka'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
